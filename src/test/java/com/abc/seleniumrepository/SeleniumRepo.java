...
public class SeleniumRepo {
	...
	public static void delete(File file) throws IOException {
		if (file.isDirectory()) { // directory is empty, then delete it
			if (null != file && null != file.list() && file.list().length == 0) {
				file.delete();
			} else {
	...
	/**
	 * @author yourname * @param locator Wait for Element load
	 */
	...
	/**
	 * @author yourname * @param locator Thread Wait
	 */
